...
This is an unsupported platform. To use it, you'll need to set your LUNA_PLATFORM variable:
    ...
    > export LUNA_PLATFORM="luna_boards.genesys2:Genesys2Platform"
...
from luna.gateware.interface.pipe       import GearedPIPEInterface, AsyncPIPEInterface
from luna.gateware.interface.serdes_phy import Kintex7SerDesPIPE
